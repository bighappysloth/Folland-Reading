...
\[
    \pi_i (x) = x
\]
equivalently, the $x$ is expressed as the linear combination of $x + 0\in W_1\oplus W_2$.
\end{definition}
...
%
% Hat Notation Is left Associative
%
...
\begin{wts}[Linear maps commute with $D^p$]\label{prop:linear-maps-commute-with-p-derivative}
