...
\begin{equation}\label{eq:finite-product-integration-product-space}
    \int_a^b f = \qty(\int_a^b\UL{\proj}[k]f)
\end{equation}


\topheader{Extension by continuity}
...
\end{wts}
% \begin{wts}[Continuity of the integral]\label{prop:step-mapping-integral-continuous}
%     The integral on $\Sigma$ is a clm into $\real$, and 
%     \begin{equation}\label{eq:step-mapping-integral-continuous}
...
% Step mapping, 
% Regulated step mapping.
% Integration definition for step mappings
% Every continuous function can be uniformly approximated by step mappings
% Extension of integration by continuity to regulated mappings.
