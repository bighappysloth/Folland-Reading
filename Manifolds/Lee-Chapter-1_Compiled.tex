...
\begin{proof}
    ...
    \]
    Now we wish to use the $c$-section Lemma in \Cref{lee-theorem6.2} in conjuction with our induction hypothesis. $C\setminus C_1\cap \cl{V}_a$ is a closed subset of compact $\cl{V}_a$, hence $F(C\setminus C_1\cap \cl{V}_a)$ is again compact. The $c$-section
    \[
