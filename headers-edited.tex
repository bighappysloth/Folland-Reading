...
\newenvironment{definition}[1][]{%
    ...
    \begin{mdframed}[%
        frametitle={Definition \theboxcounter\ #1},
        style=definitionstyle
    ]%
}{%
    \end{mdframed}
...
\newenvironment{wts}[1][]{%
    \refstepcounter{boxcounter}
    \begin{mdframed}[%
        frametitle={Proposition \theboxcounter\ #1},
        style=theoremstyle
    ]%
}{%
    \end{mdframed}
...
\newenvironment{corollary}[1][]{%
    \refstepcounter{boxcounter}
    \begin{mdframed}[%
        frametitle={Corollary \theboxcounter\ #1},
        style=theoremstyle
    ]%
}{%
    \end{mdframed}
...
\newenvironment{example}[1][]{%
    \refstepcounter{boxcounter}
    \begin{mdframed}[%
        frametitle={Example \theboxcounter\ #1},
        style=examplestyle
    ]%
}{%
    \end{mdframed}
}
% \mdtheorem[style=theoremstyle]{wts}{Proposition}[boxcounter]

% \mdtheorem[style=theoremstyle]{lemma}{Lemma}[boxcounter]
% \mdtheorem[style=theoremstyle]{corollary}{Corollary}[boxcounter]

% \mdtheorem[style=remarkstyle]{remark}{Remark}[boxcounter]

% \mdtheorem[style=notestyle]{note}{Note}[boxcounter]
% \mdtheorem[style=examplestyle]{example}{Example}[boxcounter]
