%Headers and Sections
    ...
    \newcommand{\problem}[1]{\phantomsection\subsection*{Theorem #1}\markright{Theorem #1}\addcontentsline{toc}{subsection}{Theorem #1}\setcounter{secnumdepth}{0}
...
\titleformat{\section}[hang]{\normalfont\Large\bfseries}{Chapter }{0em}{}{}
    ...
    \newcommand{\fchapter}[1]{\phantomsection\chapter*{Chapter #1}\addcontentsline{toc}{chapter}{Chapter #1}\newpage} % Chapter Number