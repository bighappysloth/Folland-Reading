...
\begin{definition}\label{chp4:topology-definition}
...
Notice this is equivlaent to $\Tau$ is the collection of all unions of basis elements in $\borel$.
...
\begin{definition}\label{chp4:finer-toplogies}
...
\begin{definition}\label{chp4:sub-basis-definition}
...
This section will be on finite (specifically binary) products of topological spaces. We start with the product topology.
\begin{definition}\label{chp4:finite-product-topology}
