...
\end{wts}
\begin{step}[Orbits of $X_q$ on $\partial \Epsilon_q$]
...
\end{proof}
\begin{step}[Action of solutions of $X_q$ on $\partial \Epsilon_q$]
...
\end{proof}
\begin{step}[Action of arbitrary Hamiltonian flows on $\partial \Epsilon_q$]
